...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('pelayanan_puskesmas', function (Blueprint $table) {
            ...
            $table->integer('kunjungan_puskesmas_lama')->nullable();
            ...
            $table->integer('penambalan_gigi_tetap_lama')->nullable();
            $table->integer('penambalan_gigi_sulung_baru')->nullable();
            $table->integer('penambalan_gigi_sulung_lama')->nullable();
            $table->integer('pencabutan_gigi_tetap_baru')->nullable();
            $table->integer('pencabutan_gigi_tetap_lama')->nullable();
            $table->integer('pencabutan_gigi_sulung_baru')->nullable();
            $table->integer('pencabutan_gigi_sulung_lama')->nullable();
            $table->integer('pembersihan_karang_gigi_baru')->nullable();
            $table->integer('pembersihan_karang_gigi_lama')->nullable();
            $table->integer('premedikasi_baru')->nullable();
            $table->integer('premedikasi_lama')->nullable();
            $table->integer('pelayanan_rujukan_gigi_baru')->nullable();
            $table->integer('pelayanan_rujukan_gigi_lama')->nullable();
            $table->integer('sd_pemeriksaan_gigi_baru')->nullable();
            $table->integer('sd_pemeriksaan_gigi_lama')->nullable();
            $table->integer('sd_perawatan_kesehatan_gigi_baru')->nullable();
            $table->integer('sd_perawatan_kesehatan_gigi_lama')->nullable();
            $table->integer('sd_mendapat_perawatan_gigi_baru')->nullable();
            $table->integer('sd_mendapat_perawatan_gigi_lama')->nullable();
            $table->integer('pemasangan_gigi_tiruan_baru')->nullable();
            $table->integer('pemasangan_gigi_tiruan_lama')->nullable();
            $table->integer('ibu_hamil_perawatan_gigi_baru')->nullable();
            $table->integer('ibu_hamil_perawatan_gigi_lama')->nullable();
            ...
            $table->integer('resep_rawat_jalan_lama')->nullable();
            $table->integer('resep_rawat_inap_baru')->nullable();
            $table->integer('resep_rawat_inap_lama')->nullable();
            $table->integer('konseling_obat_baru')->nullable();
            $table->integer('konseling_obat_lama')->nullable();
            $table->integer('pemberian_informasi_obat_baru')->nullable();
            $table->integer('pemberian_informasi_obat_lama')->nullable();
            $table->integer('antibiotik_ispa_non_pneumonia_baru')->nullable();
            $table->integer('antibiotik_ispa_non_pneumonia_lama')->nullable();
            $table->integer('ispa_non_pneumonia_baru')->nullable();
            $table->integer('ispa_non_pneumonia_lama')->nullable();
            $table->integer('antibiotik_diare_non_spesifik_baru')->nullable();
            $table->integer('antibiotik_diare_non_spesifik_lama')->nullable();
            $table->integer('diare_non_spesifik_baru')->nullable();
            $table->integer('diare_non_spesifik_lama')->nullable();
            $table->integer('injeksi_pada_myalgia_baru')->nullable();
            $table->integer('injeksi_pada_myalgia_lama')->nullable();
            $table->integer('kasus_myalgia_baru')->nullable();
            $table->integer('kasus_myalgia_lama')->nullable();
            $table->integer('obat_semua_resep_baru')->nullable();
            $table->integer('obat_semua_resep_lama')->nullable();
            $table->timestamps();
        });
    }
