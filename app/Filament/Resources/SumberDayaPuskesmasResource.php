    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                ...
                Forms\Components\TextInput::make('hasil_pelayanan_kesehatan')
                    ->numeric(),
                Forms\Components\TextInput::make('hasil_manajemen')
                    ->numeric(),
                Forms\Components\Toggle::make('feedback_dinkes_yang_diterima'),
                Forms\Components\Toggle::make('dokumen_pkp_dinkes_kota'),
                Forms\Components\TextInput::make('hasil_pelayanan_kesehatan_dinkes_kota')
                    ->numeric(),
                Forms\Components\TextInput::make('hasil_manajemen_dinkes_kota')
                    ->numeric(),
