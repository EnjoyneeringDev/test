...
<head>
  <title>LAPORAN BULANAN DATA KEMATIAN DI PUSKESMAS</title>
  <style>
    @page {
      size: A4 landscape;
      padding: 0;
...
<body>
  <div class="head">
    <p style="text-align: center;">Formulir 15</p>
    <p style="text-align: center;">LAPORAN BULANAN DATA KEMATIAN DI PUSKESMAS</p>
  </div>
  ...
  <table style="margin-top: 20px; ">
    <thead>
      <tr>
        ...
        <td class="column10 textCenter" rowspan="2">NIK</td>
        <td class="column15 textCenter" rowspan="2">Nama</td>
        <td class="column15 textCenter" rowspan="2">Alamat lengkap (Nama Jalan, RT/RW, No. rumah, Desa, Kecamatan, kab/kota, Provinsi)</td>
        <td class="column5 textCenter" rowspan="2">Umur</td>
        <td class="column5 textCenter" rowspan="2">L/P</td>
        <td class="column10 textCenter" rowspan="2">Tanggal Meninggal</td>
        <td class="column15 textCenter" rowspan="2">Tempat Meninggal</td>
        <td class="column20 textCenter" colspan="2">Sebab Dasar Kematian</td>
      </tr>
      <tr>
        <td class="column10 textCenter">Diagnosa</td>
        <td class="column10 textCenter">Kode ICD 10</td>
      </tr>
      <tr>
        ...
        <td class="column15 textCenter columGrey">8</td>
        <td class="column10 textCenter columGrey">9</td>
        <td class="column10 textCenter columGrey">10</td>
      </tr>
    </thead>
    <tbody>
      @foreach ($dataPuskesmas->kematian as $index => $data)
        <tr>
          <td class="column5 textCenter">{{ $index + 1 }}</td>
          <td class="column10">{{ $data['nik'] }}</td>
          <td class="column15">{{ $data['nama'] }}</td>
          <td class="column15">{{ $data['alamat'] }}</td>
          <td class="column5 textCenter">{{ $data['umur'] }}</td>
          <td class="column5 textCenter">{{ $data['kelamin'] }}</td>
          <td class="column10">{{ $data['tanggal_meninggal'] }}</td>
          <td class="column15">{{ $data['tempat_meninggal'] }}</td>
          <td class="column10">{{ $data['diagnosa'] }}</td>
